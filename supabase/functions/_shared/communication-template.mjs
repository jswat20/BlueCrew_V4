const TITLES = Object.freeze({
  "account-pending-approval": "Umpire Awaiting Approval", "account-approved": "Account Approved", "account-rejected": "Account Update", "claim-submitted": "New Game Claim", "claim-approved": "Claim Approved",
...
export function renderCommunicationEmail(row, { appUrl = "" } = {}) {
  ...
  const facts = row.event_type === "account-pending-approval"
    ? [["Umpire", metadata.pendingName], ["Verified Email", metadata.pendingEmail]].filter(([, value]) => value)
